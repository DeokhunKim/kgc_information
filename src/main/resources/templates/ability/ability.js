...
function enterRelic() {
    ...
    let resultHtml = '';
    if (val1 != '') {
        resultHtml += '<img src="../../static/img/staticon/StatIcon_01.png" style="width: 16px">' + val1 + '% ';
    }
    if (val2 != '') {
        resultHtml += '<img src="../../static/img/staticon/StatIcon_04.png" style="width: 16px">' + val2 + '% ';
    }
    if (val3 != '') {
        resultHtml += '<img src="../../static/img/staticon/StatIcon_03.png" style="width: 16px">' + val3 + '% ';
    }
    if (val4 != '') {
        resultHtml += '<img src="../../static/img/staticon/StatIcon_02.png" style="width: 16px">' + val4 + '% ';
    }
